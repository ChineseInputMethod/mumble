...
```mermaid
sequenceDiagram
ITfContextComposition ->> ITfProperty: 你好！李四, 最近怎么样?
ITfProperty-->>ITfComposition: 你最近怎么样，王五？
ITfProperty--x ITfContextComposition: 我很好，谢谢!
ITfProperty-x ITfComposition: 我很好，谢谢!
Note right of 王五: 李四想了很长时间, 文字太长了<br/>不适合放在一行.

ITfProperty-->>ITfContextComposition: 打量着王五...
ITfContextComposition->>ITfComposition: 很好... 王五, 你怎么样?
```
...
在Input状态，按下空格键，文本服务调用ITfProperty::>etValue();将输入的编码由Input状态转换为Converted状态。
