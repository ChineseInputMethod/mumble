...
我就不声不响的站在铁皮门后，门外是条大街，门上有钉子眼，可以透过钉子眼看到外面的世界。街上少有行人，大多时候只是空空荡荡的大街。
上小学的第一天，因为不肯站队，被建议退学。似乎我一直不擅长集体活动，从别人的角度看，我是一个很犟的人，是因为我从那个时候，就意识到我不想成为他们那样的人。
...
可能这是我第一次改变命运的机会吧，因此我有了参加科技夏令营的资格。我被分到了航模组，但是我想参加计算机组。
...
通过调用ITfContext::GetSelection()方法获得编辑范围对象ITfRange。

最后调用ITfRange::SetText()将字符写入ITfRange范围。
